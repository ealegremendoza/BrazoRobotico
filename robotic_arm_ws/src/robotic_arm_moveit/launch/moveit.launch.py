...
def generate_launch_description():
    ...
    # Create a MoveItConfigsBuilder object
    moveit_config = (
    ...
    # Move Group Node. This is the core of MoveIt, providing the planning and execution capabilities.
