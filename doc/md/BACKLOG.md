...
- [ ] **[R10]** Crear los nodos `simple_serial_transmitter` y `simple_serial_receiver` en Python (topic ↔ puerto serie) igual que en el curso — referencia: `/home/ezequiel/cursos/Robotics-and-ROS2-Manipulators/Robotics-and-ROS-2-Learn-by-Doing-Manipulators/Section9_Build/arduinobot_ws/src/arduinobot_firmware/arduinobot_firmware`
