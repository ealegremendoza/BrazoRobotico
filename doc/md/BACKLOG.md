...
- [ ] **[R07]** (Depende de R05, R06) Implementar API para manejar MoveIt2 (interfaz programática para enviar goals de planificación/ejecución al brazo, en vez de operarlo solo desde RViz)
